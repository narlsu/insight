<div class="row">
	...
	<?php if(isset($_SESSION['privilege']) && $_SESSION['privilege'] === 'admin'): ?>
	  	...
	  	<a href="./?page=movie.edit&amp;id=<?= $travelPost->id;?>" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span> Edit Movie</a>
	  
	  	<a href="./?page=movie.delete&amp;id=<?= $travelPost->id;?>" class="btn btn-danger"><span class="glyphicon glyphicon-plus"></span> Delete Movie</a>
